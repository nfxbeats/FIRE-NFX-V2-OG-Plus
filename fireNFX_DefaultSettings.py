...
#  TO PROPERLY SET YOUR OWN DEFAULTS, EDIT and READ the file: fireNFX_UserSettings.py
#
#   Rules:
#
...
class TnfxDefaultSettings:
    def __init__(self) -> None:
        ...
        # and toggle between the two, useful if you use them overlapping like I do
        self.TOGGLE_CR_AND_BROWSER = False

        # really hide the browser when closing it with the BROWSER button.
        # when thr browser closes, other windows may shift, set this to False
        # to leave the browser open. 
        # Note when TOGGLE_CR_AND_BROWSER is True, the value below is forced to always be False
